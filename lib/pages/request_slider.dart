            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                  width: 200,
                  height: 200,
                  child: FlareActor('animations/girl.flr',
                      animation: 'Swing', fit: BoxFit.contain),
                ),
                Text("Запросов больше нет...", style: TextStyle(fontFamily: "Montserrat"),),
              ],
            ),
          ),
          Container(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: Align(
                                          ...
                                          child: Text(
                                              _requestsArticles[index].userName,
                                              style: TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 20,
                                                  fontWeight:
