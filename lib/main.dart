...
class MyTabsState extends State<MyTabs> with SingleTickerProviderStateMixin {
  final List<MyTabsNav> _tabs = [
    new MyTabsNav(title: "Главная"),
    //new MyTabsNav(title: Image.asset("assets/Vector.png")),
    new MyTabsNav(title: "Добавить"),
    new MyTabsNav(title: 'Запросы'),
    new MyTabsNav(title: 'Профиль')
  ];
            ...
            new IconButton(
              ...
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => new MyMessages()));
              },
            ),
            new IconButton(
